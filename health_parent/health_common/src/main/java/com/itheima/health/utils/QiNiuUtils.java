...
public class QiNiuUtils {
    ...
    private static final String ACCESSKEY = "";// AK:已移除
    private static final String SECRETKEY = "";// SK:已移除
    private static final String BUCKET = "health-my-idea";// 仓库名
    public static final String DOMAIN= "http://qmpu6lplp.hn-bkt.clouddn.com/";// 外链域名

    public static void main(String[] args) {
        //uploadFile("D:\\jpg\\zq.jpg","zq2.jpg");
