...
public interface MessageConstant {
    ...
    static final String DELETE_CHECKITEM_CHECKGROUP_BYID = "该检查项被使用了，不能被删除";
    static final String DELETE_SETMEAL_CHECKGROUP_BYID = "该检查组已被套餐使用, 不能删除";
    ...
    static final String UPDATE_SETMEAL_SUCCESS = "新增套餐成功";
    static final String DELETE_ORDER_SETMEAL_BYID = "该套餐已被订单使用, 不能删除";
